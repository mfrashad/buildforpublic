...
const SparklesIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  ({ size = 24, color = "currentColor", strokeWidth = 2, className = "" }, ref) => {
    ...
    const start = useCallback(async () => {
      animate(".sparkle-main", { rotate: 180, scale: [1, 1.2, 1] }, { duration: 0.6, ease: "easeInOut" });
      animate(".sparkle-top", { rotate: -90, scale: [1, 0.8, 1.1], opacity: [1, 0.6, 1] }, { duration: 0.5, ease: "easeInOut", delay: 0.1 });
      animate(".sparkle-bottom", { rotate: 90, scale: [1, 1.15, 0.9], opacity: [1, 0.7, 1] }, { duration: 0.5, ease: "easeInOut", delay: 0.05 });
    }, [animate]);
